...
Provides a simple front-end API for defining what test variants look like (under A/B or multivariate testing) in separation from test administration. Provides a simple front-end sampler too to get you started. This is work in progress.
